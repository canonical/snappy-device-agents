...
from testflinger_device_agents.devices.netboot.netboot import Netboot
...
class DeviceAgent(DefaultDevice):
    ...
    def provision(self, args):
        ...
        image = testflinger_device_agents.get_image(args.job_data)
        if not image:
        ...
        test_password = testflinger_device_agents.get_test_password(
            job_data=args.job_data, default="admin"
        )
