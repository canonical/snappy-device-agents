...
from testflinger_device_agents.devices.multi.multi import Multi
from testflinger_device_agents.devices.multi.tfclient import TFClient
...
class DeviceAgent(DefaultDevice):
    ...
    def init_device(self, args):
        ...
        self.job_data = testflinger_device_agents.get_test_opportunity(
            args.job_data
        )
        testflinger_device_agents.configure_logging(self.config)
