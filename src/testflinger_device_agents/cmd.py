...
"""
Main testflinger-device-agents command module
"""
...
from testflinger_device_agents.devices import load_devices

logger = logging.getLogger()


def main():
    """main command function for testflinger-device-agents"""
